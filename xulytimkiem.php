    ...
    <div class="col-md-3 " style="height:340px"> <a href="#">
      <div class="hinh">
        ...
        <div> <img src="images/Hot/<?php echo $value['HINH_ANH']; ?>" />
          ...
          <div class="khuyenmai"><?php echo $value["CHIETKHAU"] ?>%</div>
          <?php }?>
        </div>
        <?php }?>
        <?php if($value['MA_LOAI_SP'] == "K001"){?>
        <div> <img src="images/KM/<?php echo $value['HINH_ANH']; ?>" />
          <div class="chitiet"><?php echo str_replace("\r\n","<br>", $value['DAC_DIEM']);?></div>
          <?php if($value["CHIETKHAU"]!=0){?>
          <div class="khuyenmai"><?php echo $value["CHIETKHAU"] ?>%</div>
          <?php }?>
        ...
        <div> <img src="images/New/<?php echo $value['HINH_ANH']; ?>" />
          <div class="chitiet"><?php echo str_replace("\r\n","<br>", $value['DAC_DIEM']);?></div>
          <?php if($value["CHIETKHAU"]!=0){?>
          <div class="khuyenmai"><?php echo $value["CHIETKHAU"] ?>%</div>
          <?php }?>
        ...
        <div> <img src="images/banhletiec/<?php echo $value['HINH_ANH']; ?>" />
          <div class="chitiet"><?php echo str_replace("\r\n","<br>", $value['DAC_DIEM']);?></div>
          <?php if($value["CHIETKHAU"]!=0){?>
          <div class="khuyenmai"><?php echo $value["CHIETKHAU"] ?>%</div>
          <?php }?>
        ...
        <div> <img src="images/banhkhac/<?php echo $value['HINH_ANH']; ?>" />
          <div class="chitiet"><?php echo str_replace("\r\n","<br>", $value['DAC_DIEM']);?></div>
          <?php if($value["CHIETKHAU"]!=0){?>
          <div class="khuyenmai"><?php echo $value["CHIETKHAU"] ?>%</div>
          <?php }?>
        ...
        <div> <img src="images/banhsinhnhat/<?php echo $value['HINH_ANH']; ?>" />
          <div class="chitiet"><?php echo str_replace("\r\n","<br>", $value['DAC_DIEM']);?></div>
          <?php if($value["CHIETKHAU"]!=0){?>
          <div class="khuyenmai"><?php echo $value["CHIETKHAU"] ?>%</div>
          <?php }?>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="col-md-7" style="color:#F00;">Giá Gốc: </div>
          <div class="col-md-5" style="color:#F00; <?php if($value["CHIETKHAU"]!=0){ ?> text-decoration:line-through <?php }?>"> <?php echo $value['GIA'] ?> VND </div>
          <?php if($value["CHIETKHAU"]!=0){ ?>
          <div class="col-md-7" style="color:#F00" >Giá Khuyến Mãi: </div>
          <div class="col-md-5" style="color:#F00"><?php echo $value['GIA']-(($value['CHIETKHAU']/100)*$value['GIA']) ?> VND</div>
          <?php } ?>
